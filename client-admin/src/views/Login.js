...
window.location.reload()
    ...
    return (
        <div>
            <div>
                <img src={logo} className="myFlexedImage" >
                </img>
            </div>
            <div>
                <h3 className="h2Cms">CMS</h3>
            </div>
            <div>
                <form className="login" onSubmit={handleSubmit}>
                    <input type="email" id="exampleInputEmail1" placeholder="Input Email" name="email"
                        value={inputs.email || ""}
                        onChange={handleChange} />
                    <input type="password" id="exampleInputPassword1" placeholder="Input Password"
                        name="password"
